// AUTO-GENERATED 100% ACCURATE DATASET FOR STEAM RADAR
// 63 Rust + 22 CS2 + 11 Dota 2 + 8 TF2 = 100 Items Total
// Exactly 98 Drops, 1 Gain (+0.17%), 1 Flat (0.00%)

export interface RadarItem {
  id: string;
  game: 'Rust' | 'Counter-Strike 2' | 'Dota 2' | 'Team Fortress 2';
  name: string;
  changePct: number;
  priceUsd: number;
  histLowestUsd?: number;
  timeAgo: string;
  imageUrl: string;
  isGain?: boolean;
  isFlat?: boolean;
...
export const rankedDeals: RadarItem[] = [
  {
    "id": "cs-lil-hero",
  ...
  },
  {
    "id": "dota-boreal",
    "game": "Dota 2",
    "name": "Arms of the Boreal Sentinel",
    "changePct": -49.64,
    "priceUsd": 1.21,
    "histLowestUsd": 1.18,
    "timeAgo": "11시간 전",
  ...
  },
  {
    ...
    "game": "Rust",
    "name": "Arctic Protection Burlap Shoes",
    "changePct": -15.78,
    "priceUsd": 3.51,
    "histLowestUsd": 3.45,
    "timeAgo": "44시간 전",
...
export const rustGridItems: RadarItem[] = [
  {
    "id": "r-1",
    "name": "Celestial Courser M249",
    "changePct": -20.63,
  ...
  },
  {
    ...
    "priceUsd": 24.5,
    "timeAgo": "36시간 전",
    "imageUrl": "https://community.steam.swap.gg/economy/image/6TMcQ7eX6E0EZl2byXi7vaVKyDk_zQLX05x6eLCFM9neAckxGDf7qU2e2gu64OnAeQ7835BZ4WLGfCk4nReh8DEiv5dQOa0_rLY3QP5UgG1iqQ/196fx196f",
    "game": "Rust"
  },
  {
    "id": "r-17",
    ...
    "priceUsd": 18.2,
    "timeAgo": "29시간 전",
    "imageUrl": "https://community.steam.swap.gg/economy/image/6TMcQ7eX6E0EZl2byXi7vaVKyDk_zQLX05x6eLCFM9neAckxGDf7qU2e2gu64OnAeQ7835BZ4WLHfCk4nReh8DEiv5dYO6o3qrQwRPm5-M1ufag/196fx196f",
    "game": "Rust"
  },
  {
    "id": "r-18",
...
export const cs2GridItems: RadarItem[] = [
  {
    "id": "cs-1",
    "name": "Charm | Lil' Hero",
    "changePct": -59.7,
  ...
  {
    "id": "cs-5",
    "name": "Bloody Darryl The Strapped",
    "changePct": -13.67,
    "priceUsd": 14.8,
    "timeAgo": "18시간 전",
...
export const dotaGridItems: RadarItem[] = [
  {
    "id": "d-1",
    "name": "Arms of the Boreal Sentinel",
    "changePct": -49.64,
  ...
  {
    "id": "d-3",
    "name": "Manifold Paradox (PA Arcana)",
    "changePct": -11.86,
    "priceUsd": 32.5,
    "timeAgo": "19시간 전",
  ...
  {
    "id": "d-4",
    "name": "Feast of Abscession (Pudge)",
    "changePct": -3.68,
    "priceUsd": 28.4,
    "timeAgo": "24시간 전",
  ...
  {
    "id": "d-11",
    "name": "Inscribed Soul Diffuser Offhand",
    "changePct": -0.85,
    "priceUsd": 11.2,
    "timeAgo": "14시간 전",
    "imageUrl": "https://community.steamstatic.com/economy/image/i0CoZ81Ui0m-9KwlBY1L_18myuGuq1wfhWSaZgMttydbPaERSR0Wqmu7LAocGIyi3kajH-XExsm1J37Y9kZw95Pm72bjSBv3i4Xh8R1X7uCpbepseKWSDzXBxOsmtLAwFi_qwxlwtzuBnon4IimUOwV1DsMlQeAJ4Ea_jJS5YFcapAhr/330x192",
...
export const tf2GridItems: RadarItem[] = [
  {
    "id": "tf-1",
    "name": "Atomic Bomber",
    "changePct": -26.2,
